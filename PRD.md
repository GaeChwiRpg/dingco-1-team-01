...
| 3 | 그 숫자가 실제보다 낮다는 것까지 | 측정 8ⓐ-2 = 0.333 (감사가 3건 중 1건만 잡음) + AI 답을 보여줘서 생기는 쏠림 | **부분** — **측정 12(사람끼리 갈리는 몫)가 아직 없다** |

**2번이 0 이 아니라는 것이 이 프로젝트의 답이다.** 확신도만 보고 거르는 방식으로는 저 3건을 못 잡는다.

**3번은 절반만 채워졌다.** 감사가 놓친 몫(2건)은 숫자로 나왔지만, **사람끼리 갈리는 몫(측정 12)은 아직 안 쟀다.** 이 상태로는 *"오분류율이 실제보다 낮게 나온다"* 까지만 말할 수 있고 **"얼마나 낮은지"** 는 못 말한다.

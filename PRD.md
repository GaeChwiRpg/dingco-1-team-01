...
| R — 측정 | **거의 됨** | 2 · 6(절감률) · 11(캐시 hit) · a·b·c |

**남은 것은 「속도」와 「절약이 실제로 얼마나 됐나」다.** 결론에 필요한 숫자(측정 8ⓐ·8ⓑ·12)는 이미 나왔고, 남은 넷은 **결론을 바꾸지 않고 보강한다.**

> **가장 큰 구멍은 속도(a·b·c)가 하나도 안 재진 것이다.** §9 아래 「속도 목표」의 세 값은 **전부 목표이지 실측이 아니다.**

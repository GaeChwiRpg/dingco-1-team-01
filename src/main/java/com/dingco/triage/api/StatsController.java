...
/**
 * {@code GET /api/stats} (계약 §7, TRI-72). 운영 통계.
 *
 ...
 *
 * <p><b>지금 상태 — {@code classification.stuckReceived} 만 내보낸다 (TRI-72).</b> 계약 §7 의
 * 나머지 블록({@code backlog} · {@code aiCallSavings} · {@code cache} · {@code audit})은 각 측정
...
public class StatsController {
    ...
    @GetMapping
    StatsResponse stats() {
        return StatsResponse.of(statsService.stuckReceivedCount());
    }
}

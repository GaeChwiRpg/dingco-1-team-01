 ...
 * 도메인 전환으로 그룹핑을 포기하면서 <b>판정 단위가 문의 1건으로 내려왔다</b> (D-031) —
...
public class Inquiry {
     ...
     * 마스킹을 거친다 (D-031). 저장은 원문 그대로 하되 나가는 자리에서 가린다.
     */
     ...
     *
     * <p><b>이 트랜잭션은 ②와 분리된 채로 커밋된다 (D-031).</b> ②(분류 결과 저장)가 실패해도

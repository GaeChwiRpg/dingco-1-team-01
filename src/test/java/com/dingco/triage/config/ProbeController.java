 ...
 * P1/P2 가 진짜 컨트롤러를 만들면 이 파일은 지운다.
 *
...
public class ProbeController {
    ...
    @GetMapping("/api/inquiry-review-queue")
    String listQueue() {
        return "ok";
    }

    @PatchMapping("/api/inquiry-review-queue/{id}")
    String confirmQueueItem(@PathVariable Long id) {
        return "ok";
    }

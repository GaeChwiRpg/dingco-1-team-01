...
> 측정 1·4·12 가 김준현에게 몰린 것은 **AI 호출·재시도·정답 레이블이 전부 P2 소유**이기 때문이다. 다만 Day 4 에 겹치므로 측정 4 를 Day 3 으로 당겨 분산했다 — **측정 3 이 Day 4 로 옮기기 전에는 측정 3 과 같은 날이었지만, 지금은 김준현이 Day 3 을 혼자 쓴다.**
